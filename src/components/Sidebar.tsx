import { LayoutDashboard, Phone, MessageSquare, Calendar, Settings, CreditCard, Info, Users, Brain } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const navigation = [
    ...
    { name: 'Supervisor Insights', href: '/supervisor-insights', icon: Brain },
