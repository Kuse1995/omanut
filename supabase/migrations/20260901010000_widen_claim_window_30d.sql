-- Widen the claim_pending_events window so stuck meta comment events
-- (July 26-29) become processable by meta-auto-reply. The old 1-hour window
-- permanently stranded them as 'pending'. Forward-only, idempotent.
